...
from megatron.core.datasets.utils import normalize, should_build_on_rank
...
class BlendedDataset(torch.utils.data.Dataset):
    ...
    def _build_indices(self) -> Tuple[numpy.ndarray, numpy.ndarray]:
        ...
        if not path_to_cache or (not cache_hit and should_build_on_rank(self.config.shared_filesystem)):
