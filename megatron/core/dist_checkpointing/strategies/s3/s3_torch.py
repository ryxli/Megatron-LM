...
from megatron.core.dist_checkpointing.strategies.s3.placeholder import S3Path
...
class S3TorchDistLoadShardedStrategy(TorchDistLoadShardedStrategy):
    def load(self, sharded_state_dict: ShardedStateDict, checkpoint_dir: Path | PathBase | str) -> StateDict:
